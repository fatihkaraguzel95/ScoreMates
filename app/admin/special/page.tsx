  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Haftalık istatistik sorularını yönet.</p>
      </div>
      ...
      {loaded && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Soru metinlerini düzenleyin. Üyelerin oybirliğiyle onayladığı sorular otomatik olarak buraya eklenir.
            </CardDescription>
          </CardHeader>
            ...
            {calcResult && (
              <div className="mt-3 p-3 rounded-lg bg-muted space-y-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Kazanan{calcResult.winners.length > 1 ? "lar" : ""}: {calcResult.winners.length} kişi →{" "}
                  <Badge>{calcResult.bonusPoints} puan</Badge>
                </p>
              </div>
            )}
          </CardContent>
      ...
      <Card>
        ...
        <CardContent className="text-sm text-muted-foreground space-y-1">
          <p>1. Kullanıcılar <strong>Tahmin Gir</strong> ekranından soru önerir.</p>
          <p>2. Ligteki tüm üyeler önerilen soruları <strong>onaylar</strong>.</p>
          <p>3. Herkes onaylarsa soru <strong>otomatik olarak</strong> özel tahminlere eklenir.</p>
